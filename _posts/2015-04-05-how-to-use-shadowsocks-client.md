...
给你的 Chrome 安装 [SwitchyOmega](https://chrome.google.com/webstore/detail/proxy-switchyomega/padekgcemlokbadohgkifijomclgjgif) ，在其“`导入/导出`”设置页面选择从 [备份文件](/assets/file/OmegaOptions.bak) 恢复配置。
